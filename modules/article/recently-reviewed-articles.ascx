<%@ Control Language="C#" AutoEventWireup="true" CodeFile="recently-reviewed-articles.ascx.cs"
    Inherits="modules_makale_en_son_yorumlanan_makaleler" %>
...
<asp:SqlDataSource ID="SDSMak" runat="server" ConnectionString="<%$ ConnectionStrings:e_cobiConn %>"
    SelectCommand="snlg_V1.zsp_Makale_EnSonYorumlanan" SelectCommandType="StoredProcedure"
