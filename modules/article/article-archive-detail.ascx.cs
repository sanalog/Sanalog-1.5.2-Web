...
public partial class modules_makale_arsivdeki_makaleler_sayfa : Snlg_UserControlBaseClass
{
    //bir sayfada kaç kayıt gösterilecek
    protected byte _PageSize = 1;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DBPrms[4] = new Snlg_DBParameter("@Ay", SqlDbType.Int, Convert.ToInt32(Request.QueryString["mak_arsiv_ay"]));
        DBPrms[5] = new Snlg_DBParameter("@Yil", SqlDbType.Int, Convert.ToInt32(Request.QueryString["mak_arsiv_yil"]));
        #endregion

        DataTable Dt = vt.DataTableOlustur("snlg_V1.zsp_Makale_ArsivdekiMakaleler ", CommandType.StoredProcedure, DBPrms);
        if (Dt.Rows.Count > 0)
        {
            Rpt.DataSource = Dt;
            Rpt.DataBind();
    ...
    public string MakaleKategoriListesi(string MakaleID)
    {
        ...
        DBPrms[0] = new Snlg_DBParameter("@MakId", SqlDbType.Int, int.Parse(MakaleID));
