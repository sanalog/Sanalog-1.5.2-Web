...
public partial class modules_duyuru_duyurular_resimli_sayfa : Snlg_UserControlBaseClass
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        using (SqlDataReader SDRDyr =  vt.DBReaderOlustur("snlg_V1.zsp_Duyurular", CommandType.StoredProcedure, DBPrms))
        {
