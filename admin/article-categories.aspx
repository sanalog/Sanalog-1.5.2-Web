<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MasterPage.master" AutoEventWireup="true" CodeFile="article-categories.aspx.cs" Inherits="admin_article_categories" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH1" runat="Server">
    ...
    <div class="row makaleKategorileri">
        <div class="col-md-12">

            <div class="page-head-x4"><%= Resources.admin_language.article_cat_title %></div>
            <div class="page-head-x1">
                <%= Resources.admin_language.article_cat_help %>
            </div>
            <div id="global_errors" class="errors-out">
                <div class="errors-in"></div>
            </div>
            <div class="row buttons mb-md">
                <div class="col-md-12">
                    <asp:LinkButton ID="BtnSil" runat="server" class="btn btn-danger icon_sil"
                        data-bb="confirm" data-confirm-text="Silmek istediğinizden emin misiniz?"
                        OnClick="BtnSil_Click" Text="<%$ Resources:admin_language, menu_delete2 %>" title="Seçili Kategorileri Siler"></asp:LinkButton>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="panel">
                        <div class="panel-heading"><%= Resources.admin_language.article_categories %></div>
                                    ...
                                    <EditItemTemplate>
                                        <div class="panel">
                                            <div class="col-md-12">
                                                ...
                                                <div class="row form-group no-gutter">
                                                    <label class="col-md-4"><%= Resources.admin_language.article_cat_active %></label>
                                                    <div class="col-md-8">
                                        ...
                                        <div data-buttons="1" style="display: none">
                                            <asp:LinkButton ID="LinkButton1" CommandName="Update" ValidationGroup="sduzenle" Text="<%$ Resources:admin_language, save %>" runat="server" class="btn btn-info icon_kaydet"></asp:LinkButton>
                                            <a href="article-categories.aspx" class="btn btn-default icon_kapat"><%= Resources.admin_language.close %></a>
                                        </div>
                                    ...
                                    <InsertItemTemplate>
                                        <div class="panel">
                                            <div class="col-md-12">
                                                ...
                                                <div class="row form-group no-gutter">
                                                    <label class="col-md-4"><%= Resources.admin_language.article_cat_url %></small></label>
                                                    <div class="col-md-8">
                                                        <div class="input-group">
                                                            <asp:TextBox ID="TxtUrl" CssClass="form-control" runat="server" MaxLength="200" Text='<%# Bind("SeoUrl") %>'></asp:TextBox>
                                                            <span class="input-group-addon"><%= Snlg_ConfigValues.urlExtension %></span>
                                                        </div>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TxtUrl" CssClass="hata"
                                        ...
                                        <div data-buttons="1" style="display: none">
                                            <asp:LinkButton ID="LinkButton4" CommandName="Insert" ValidationGroup="sekle" runat="server" Text="<%$ Resources:admin_language, save %>" alt="Ekle" class="btn btn-info icon_kaydet"></asp:LinkButton>
                                        </div>
                                    </InsertItemTemplate>
                                </asp:FormView>
                            </div>
    ...
    <asp:SqlDataSource ID="SDSSyf" runat="server" ConnectionString="<%$ ConnectionStrings:e_cobiConn %>"
        SelectCommand="snlg_V1.msp_MakaleKategoriDetaySec" SelectCommandType="StoredProcedure"
        InsertCommand="snlg_V1.msp_MakaleKategoriOlustur"
        InsertCommandType="StoredProcedure"
        OnInserted="SDSSyf_Inserted"
        OnSelected="SDSSyf_Selected"
        UpdateCommand="snlg_V1.msp_MakaleKategoriDuzenle"
        UpdateCommandType="StoredProcedure"
        OnUpdated="SDSSyf_Updated"
        OnInserting="SDSSyf_Inserting" OnUpdating="SDSSyf_Updating">
        <SelectParameters>
