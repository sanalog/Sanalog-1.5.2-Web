                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row form-group no-gutter">
                                    ...
                                    <div class="col-md-8">
                                        <asp:TextBox ID="TbTarih1" CssClass="form-control" runat="server" Text='<%# Bind("Tarih1") %>' MaxLength="20" rel="tarih" />
                                ...
                                <div class="row form-group no-gutter">
                                    ...
                                    <div class="col-md-8">
                                        <asp:TextBox ID="TbTarih2" CssClass="form-control" runat="server" Text='<%# Bind("Tarih2") %>' MaxLength="20" rel="tarih" />
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row form-group no-gutter">
                                    <label class="col-md-4"><%= Resources.admin_language.activity_s_date %></label>
                                    <div class="col-md-8">
                                        <asp:TextBox ID="TbTarih1" CssClass="form-control" runat="server" Text='<%# Bind("Tarih1") %>' MaxLength="20"
                                            rel="tarih" />
                                        <asp:RequiredFieldValidator runat="server" ControlToValidate="TbTarih1" CssClass="hata"
                                            Display="Dynamic" ErrorMessage="*" ValidationGroup="sekle" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                    </div>
                                ...
                                <div class="row form-group no-gutter">
                                    <label class="col-md-4"><%= Resources.admin_language.activity_f_date %></label>
                                    <div class="col-md-8">
                                        <asp:TextBox ID="TbTarih2" CssClass="form-control" runat="server" Text='<%# Bind("Tarih2") %>' MaxLength="20"
                                            rel="tarih" />
