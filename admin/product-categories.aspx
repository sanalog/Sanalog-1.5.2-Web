<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MasterPage.master" AutoEventWireup="true" CodeFile="product-categories.aspx.cs" Inherits="admin_product_categories" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH1" runat="Server">
    <div class="row urunKategorileri">
        <div class="col-md-12">
            ...
            <div class="page-head-x4"><%= Resources.admin_language.products_cat_title %></div>
            <div class="page-head-x1"><%= Resources.admin_language.products_cat_help %></div>
            ...
            <div class="row mb-md buttons" data-spy="affix" data-offset-top="150">
                <div class="col-md-12">
                    <asp:LinkButton ID="BtnSil" runat="server" Text="<%$ Resources:admin_language, menu_delete2 %>" class="btn btn-danger icon_sil"
                        data-bb="confirm" data-confirm-text="Silmek istediğinizden emin misiniz?"
                        OnClick="LKtgSil_Click"></asp:LinkButton>
            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    <div class="panel">
                        <div class="panel-heading"><%= Resources.admin_language.products_created_cat %></div>
                                ...
                                <asp:FormView ID="FVSyf" runat="server" DataKeyNames="KtgId" DataSourceID="SDSSyf"
                                    ...
                                    <EditItemTemplate>
                                        <div class="panel">
                                            <div class="col-md-12">
                                                ...
                                                <div class="row form-group no-gutter">
                                                    <label class="col-md-4"><%= Resources.admin_language.products_cat_name %></label>
                                                    <div class="col-md-8">
                                        ...
                                        <div data-buttons="1" style="display: none">
                                            <asp:LinkButton ID="LinkButton1" CommandName="Update" ValidationGroup="sduzenle" Text="<%$ Resources:admin_language, save %>"
                                                runat="server" class="btn btn-info icon_kaydet"></asp:LinkButton>
                                    <a href="product-categories.aspx" class="btn btn-default icon_kapat"><%= Resources.admin_language.close %></a>
                                        </div>
                                    </EditItemTemplate>
                                    <InsertItemTemplate>
                                        <div class="panel">
    ...
    <asp:SqlDataSource ID="SDSSyf" runat="server" ConnectionString="<%$ ConnectionStrings:e_cobiConn %>"
        SelectCommand="snlg_V1.msp_UrunKategoriDetaySec" SelectCommandType="StoredProcedure"
        InsertCommand="snlg_V1.msp_UrunKategoriOlustur"
        InsertCommandType="StoredProcedure"
        OnInserting="SDSSyf_Inserting"
        OnInserted="SDSSyf_Inserted"
        OnSelected="SDSSyf_Selected"
        UpdateCommand="snlg_V1.msp_UrunKategoriDuzenle"
